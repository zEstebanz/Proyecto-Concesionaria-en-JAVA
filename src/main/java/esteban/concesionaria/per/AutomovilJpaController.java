 ...
 * OMR DE JAVA PARA MAPEAR OBJETOS DE LA BASE DE DATOS
 */
public class AutomovilJpaController implements Serializable {
    ...
    //Cuando llamemos este constructor se crea la emf (emptityManagerFactory)
    //Para que pueda utilizarse todo estos metodos create, edit, etc.
