...
public class ModifAuto extends javax.swing.JFrame {
    ...
    //null para q no cargue los datos antes de utilizarlo, es una buena practica y siempre creara una nueva instancia
    Controladora control = null;
    //objeto global de auto
    Automovil auto = new Automovil();
    
    public ModifAuto(int idAuto) {
        
        //Aca la creo al control.
        control = new Controladora();
        initComponents();
        
        //que se llame cargar datos para modificar cuando se hace click en modificar y lo pasamos a la logica
    ...
    private void initComponents() {
        ...
        btnSalir2.setBackground(new java.awt.Color(0, 204, 204));
        btnSalir2.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        ...
        Foto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gris_1.jpg"))); // NOI18N
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(Foto, javax.swing.GroupLayout.PREFERRED_SIZE, 289, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        //Que los datos se asignen bien al auto seleccionado para eso sirve el objeto global del auto

        //Traemos todos los datos del auto y lo guardamos en variables auxiliares:

        String modelo = txtModelo.getText(); //Todo lo q este en el txt es tomado por el get se guarda
        String marca = txtMarca.getText();
        String motor = txtMotor.getText();
        String color = txtColor.getText();
        String patente = txtPatente.getText();

        //Modificar un auto en particular y accinando los nuevos valores.
        //primero recolectamos y se lo pasamos a la logica.

        control.modificarAuto(auto, modelo, marca, color, patente, motor);

        //Si sale bien se muestra el siguiente mensaje
        mostrarMensaje("Edición realizada correctamente", "info", "Edición Exitosa");

        //Por ultimo cierra la pestaña y me muestra la pestaña anterior ConsultaAutomovil
    ...
    private void cargarDatosAuto(int idAuto) {
        ...
        //Conectando a la Logica
        //control para comunicar con la logica
        //2 creamos el objeto auto para poder traer el auto a nmodificar
        //3 un metodo para que traiga el auto asociado al id. 
        
        auto = control.traerAuto(idAuto);
        
        //Para que se muestren los datos traido de la BD se hace lo siguiente
        ...
        //cuando se abra la pantalla que cargue los datos
